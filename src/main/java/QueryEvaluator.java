...
public class QueryEvaluator {
    ...
    public ANALYSE_TYPE getType() {
        return type;
    }

    public void setType(ANALYSE_TYPE type) {
        this.type = type;
    }

    public static enum ANALYSE_TYPE {
        SYNONYMS,
        RELATION,
        BOTH
    }
...
//                        tmp.add(addTerms.get(addTerms.size() - 1));
                ...
                if (normal) {
                    ...
                    result.add(evaluateQuery(enrichedQuery, connection));
                }
            }
            connection.close();
        } catch (SQLException e) {
